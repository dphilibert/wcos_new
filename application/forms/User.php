...
class Form_User extends Zend_Form
{
  ...
  var $action = '/admin/accounts/new';
  var $name = 'user_form_new';
  var $method = 'POST';
  ...
  public function init ()
  {
    ...
    $password->setLabel ('Passwort:*')->setAttrib ('class', 'inputText')->setRequired (true)->addDecorators ($this->decorators);
    ...
    $submit->setLabel ('Speichern')->setAttrib ('class', 'buttonSave ui-corner-all')->setAttrib ('onclick', 'submit_form ("'.$this->action.'", "'.$this->name.'", "editor");');
        
    $this->addElements (array (
      $name, $password, $status, $provider, $submit  
    ));
  }        
}
?>
